 ...
 *
 *	OWN declare $atags and filter_xss(html_entity_decode()) $tree, $prev_title and $next_title
 */
 $atags = array('a', 'em', 'i', 'strong', 'cite', 'code', 'ul', 'ol', 'li', 'dl', 'dt', 'dd');
?>
<?php if ($tree || $has_links): ?>
  <div id="book-navigation-<?php print $book_id; ?>" class="book-navigation">
    <?php print filter_xss(html_entity_decode($tree), $atags); ?>

    <?php if ($has_links): ?>
    <div class="page-links clear-block">
      <?php if ($prev_url) : ?>
        <a href="<?php print $prev_url; ?>" class="page-previous" title="<?php print t('Go to previous page'); ?>"><?php print t('‹ ') . filter_xss(html_entity_decode($prev_title), $atags); ?></a>
      <?php endif; ?>
      <?php if ($parent_url) : ?>
        <a href="<?php print $parent_url; ?>" class="page-up" title="<?php print t('Go to parent page'); ?>"><?php print t('up'); ?></a>
      <?php endif; ?>
      <?php if ($next_url) : ?>
        <a href="<?php print $next_url; ?>" class="page-next" title="<?php print t('Go to next page'); ?>"><?php print filter_xss(html_entity_decode($next_title), $atags) . t(' ›'); ?></a>
      <?php endif; ?>
    </div>
    <?php endif; ?>
